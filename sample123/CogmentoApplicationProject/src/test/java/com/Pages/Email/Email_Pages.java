...
public class Email_Pages extends Library{
	...
	//Getting elements
			...
			public void loginn(String email1,String pass1) {
				txtEmail1.sendKeys(email1);
				txtPassword1.sendKeys(pass1);
			...
			public void template() {
				 sUtil1 = new SeleniumUtilities(driver); 
