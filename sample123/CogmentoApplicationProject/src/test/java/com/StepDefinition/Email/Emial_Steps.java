package com.StepDefinition.Email;
...
public class Emial_Steps extends Library {
	...
	public void enter_Email_and_password() {
       epage=new Email_Pages(driver);
		 epage.loginn(properties.getProperty("loginEmail"), properties.getProperty("LoginPassword"));
	...
	public void get_the_page_title_and_screen_shot() {
		sUti1 = new SeleniumUtilities(driver);
		sUti1.to_take_screenshot("src/test/resources/ScreenShots/CogmentoLogin.png");
